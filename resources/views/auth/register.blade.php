							...
							<div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <a href="#" class="input-group-text text-dark btn btn-toggle-password {{ $errors->has('password') ? 'bg-danger' : 'bg-primary' }}"><i class="fa fa-eye text-white"></i></a>
                                    </div>
                                </div>
...
<link href="{{ asset('templates/vali-admin/css/main.css') }}" rel="stylesheet">
<style type="text/css">
