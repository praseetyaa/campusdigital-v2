  ...
  <div class="container">
    <div class="row align-items-center" style="margin-bottom: 8rem">
      ...
      <div class="col-lg-6 order-1 order-lg-2 mb-3 mb-lg-0">
        <img class="d-none d-lg-block mx-auto" src="{{asset('assets/images/illustration/min/7747.png')}}" alt="banner" style="max-width: 400px">
      </div>
    </div>
    <div class="row align-items-center">
      <div class="col-lg-6 order-1 order-lg-2 mb3 mb-lg-0">
        <h1>Mengapa Kami?</h1>
      ...
      <div class="col-lg-6 order-2 order-lg-1 text-center text-lg-left">
        <img class="d-none d-lg-block mx-auto" src="{{asset('assets/images/illustration/min/5237.png')}}" alt="banner" style="max-width: 450px">
      </div>
    </div>
  </div>
</section>
