      ...
      <div class="section_header">
        <div class="row align-items-center mb-5">
          <div class="col-lg-6 order-2 order-lg-1 text-center text-lg-start">
            ...
            <h4 class="fw-normal">Informasi Pendaftaran Di Campus Digital</h4>
          </div>
      ...
      <div class="bg-light p-4 rounded-1">
        <div class="section-info">
          ...
          <p class="fw-bold">Syarat Pendaftaran:</p>
            <p>1. Minimal Lulusan SLTA / sederajat</p>
            <p>2. Melampirkan Foto copy ijazah terakir yang dilegalisir</p>
            <p>3. Melampirkan foto copy KTP orang tua 1 (satu) lembar</p>
          ...
          <p>1. Registrasi / daftar ulang paling lambat 10 hari setelah mendaftar/dinyatakan diterima
                (Bagi yang tidak sesuai ketentuan, maka tidak mendapat fasilitas bonus lainnya (kost Gratis/ subsidi kost, Beasiswa)</p>
          <p>2. Mengembalikan Buku Ketentuan yang telah ditandatangani oleh calon Peserta didik dan orang tua/wali</p>
          <p>3. Membayar uang Registrasi</p>
        </div>  
      </div>
    </div>
  </div>
